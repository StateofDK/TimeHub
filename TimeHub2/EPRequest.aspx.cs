...
namespace TimeHub2
{
    public partial class EPRequest1 : System.Web.UI.Page
    {
        ...
        protected void ConfigurePageNew(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                ...
                {
                    message = "new request population error: " + ex.Message;
                    ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + ex.Message + "');", true);
                }
                try
                {
                ...
                {
                    message = "new page configuration error: " + ex.Message;
                    ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + ex.Message + "');", true);
                }
            }
        }
        ...
        protected void ConfigurePageExisting(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("spSelectExistingRequestDataEP", conn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    ...
                    SqlParameter inPlaceName = new SqlParameter();
                    SqlParameter inPlaceRank = new SqlParameter();
                    ...
                    inPlaceName.ParameterName = "@InPlaceName";
                    inPlaceRank.ParameterName = "@InPlaceRank";
                    ...
                    inPlaceName.SqlDbType = System.Data.SqlDbType.VarChar;
                    inPlaceRank.SqlDbType = System.Data.SqlDbType.VarChar;
                    ...
                    inPlaceName.Size = 200;
                    inPlaceRank.Size = 200;
                    statusId.Size = 200;
                    ...
                    inPlaceName.Direction = System.Data.ParameterDirection.Output;
                    inPlaceRank.Direction = System.Data.ParameterDirection.Output;
                    ...
                    cmd.Parameters.Add(inPlaceName);
                    cmd.Parameters.Add(inPlaceRank);
                    ...
                    string inPlaceNameOut = inPlaceName.Value.ToString();
                    string inPlaceRankOut = inPlaceRank.Value.ToString();
                    ...
                    tbInPlaceName.Text = inPlaceNameOut;
                    tbInPlaceRank.Text = inPlaceRankOut;
                ...
                {
                    message = "existing request population error: " + ex.Message;
                    ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + ex.Message + "');", true);
                }
                ...
                {
                    message = "error displaying buttons: " + ex.Message;
                    ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + ex.Message + "');", true);
                }
        ...
        protected void CardReadOnly(object sender, EventArgs e)
        {
            ...
            tbInPlaceName.ReadOnly = true;
            tbInPlaceRank.ReadOnly = true;
        }
        ...
        protected void CardEditable(object sender, EventArgs e)
        {
            ...
            tbInPlaceName.ReadOnly = false;
            tbInPlaceRank.ReadOnly = false;
        }
        ...
        protected void WriteApprovalInfoToCard(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                ...
                {
                    message = "error writing approval info to request: " + ex.Message;
                    ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + ex.Message + "');", true);
                }
            }
        }
        ...
        protected void btnSignClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                ...
                {
                    message = "card population error: " + ex.Message;
                    ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + ex.Message + "');", true);
                }
            }
        ...
        protected void btnSaveClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("spInsertRequestEP", conn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.Add("@DateSubmitted", SqlDbType.VarChar).Value = tbSubmittedDate.Text;
                    ...
                    cmd.Parameters.Add("@CreatedBy", SqlDbType.Int).Value = lblUserLoggedIn.Text;
        ...
        protected void btnSubmitClick(object sender, EventArgs e)
        {
            if (string.IsNullOrWhiteSpace(tbCardNumber.Text))
            {
                ...
                using (SqlConnection conn = new SqlConnection(connstring))
                {
                    ...
                    {
                        message = "Submit error: " + ex.Message;
                        ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + "');", true);
                    }
                }
            }
            else
            {
                ...
                using (SqlConnection conn = new SqlConnection(connstring))
                {
                    try
                    {
                        SqlCommand cmd = new SqlCommand("spUpdateRequestEP", conn);
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
                        ...
                        message = "Request submitted/ edited successfully: ";
                        DisplaySuccessDialog(null, null);
                    ...
                    {
                        message = "submit/ edit error: " + ex.Message;
                        ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + "');", true);
                    }
                }
            }
        ...
        protected void btnWithdrawClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spUpdateRequestStatusEP";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
        ...
        protected void btnApproveClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spUpdateRequestApproveEP";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
                ...
                {
                    message = "Approval error: " + ex.Message;
                    ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + ex.Message + "');", true);
                }
            }
        }
        ...
        protected void btnReturnClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spReturnRequestEP";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
                    ...
                    message = "request returned to user";
                    DisplaySuccessDialog(null, null);
                ...
                {
                    message = "return error: " + ex.Message;
                    ClientScript.RegisterStartupScript(this.GetType(), "Popup", "ShowPopup('" + message + ex.Message + "');", true);
                }
            }
        }
