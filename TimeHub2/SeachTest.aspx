<%@ Page Title="" Language="C#" MasterPageFile="~/TimeHub.Master" AutoEventWireup="true" CodeBehind="SeachTest.aspx.cs" Inherits="TimeHub2.SeachTest" %>
                ...
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-horizontal">
                            ...
                            <asp:CheckBoxList runat="server" ID="cblRequestType" class="" RepeatDirection="Horizontal" ClientIDMode="Static">
                                <asp:ListItem runat="server" Text="All Request Types"></asp:ListItem>
                                <asp:ListItem runat="server" Text="Court"></asp:ListItem>
                                <asp:ListItem runat="server" Text="Overtime"></asp:ListItem>
                                <asp:ListItem runat="server" Text="Training"></asp:ListItem>
                                <asp:ListItem runat="server" Text="Time-off"></asp:ListItem>
                                <asp:ListItem runat="server" Text="Equal-Pay"></asp:ListItem>
                            </asp:CheckBoxList>
                        </div>
                    </div>

                    <div class="row" id="otOptions" style="display: none">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label>Overtime Code</label>
                            <input type="text" placeholder=".col-md-3" class="form-control">
                        </div>
                    </div>

                    <div class="row" id="coOptions" style="display: none">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label>Court Session</label>
                            <input type="text" placeholder=".col-md-3" class="form-control">
                        </div>
                    ...
                    <div class="row" id="trOptions" style="display: none">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
...
<asp:Content ID="Foot" ContentPlaceHolderID="foot" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $('#cblRequestType input').change(function () {
                var $coOptions = $('#coOptions'),
                    //$epOptions = $('#epOptions'),
                    $otOptions = $('#otOptions'),
                    //$toOptions = $('#toOptions'),
                    $trOptions = $('#trOptions'),

                    $allCheckbox = $('#cblRequestType_0'),
                    $coCheckbox = $('#cblRequestType_1'),
                    $otCheckbox = $('#cblRequestType_2'),
                    $trCheckbox = $('#cblRequestType_3'),
                    $toCheckbox = $('#cblRequestType_4'),
                    $epCheckbox = $('#cblRequestType_5');

                if ($allCheckbox.is(':checked')) {
                    $coCheckbox.prop("checked", true);
                    $otCheckbox.prop("checked", true);
                    $trCheckbox.prop("checked", true);
                    $toCheckbox.prop("checked", true);
