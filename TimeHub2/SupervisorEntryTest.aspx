<%@ Page Title="" Language="C#" MasterPageFile="~/TimeHub.Master" AutoEventWireup="true" CodeBehind="SupervisorEntryTest.aspx.cs" Inherits="TimeHub2.SupervisorEntryTest" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Request Type<small>select one</small></h2>
                    <div class="nav">
                        <asp:RadioButtonList runat="server" ID="rblRequestType" class="navbar-right" RepeatDirection="Horizontal">
                ...
                <div class="x_content">
                    ...
                    <div class="row" id="coOptions" runat="server" style="display: none">
                                    ...
                                    <asp:GridView ID="gvEmployeeInfo" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Request ID">
                                                ...
                                                <FooterTemplate>
                                                    <asp:Button ID="btnAdd" runat="server" Text="Commit Entries" CommandName="Footer" />
                                                </FooterTemplate>
                                            </asp:TemplateField>
