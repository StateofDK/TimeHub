...
namespace TimeHub2
{
    public partial class OTRequest1 : System.Web.UI.Page
    {
        ...
        protected void ConfigurePageExisting(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("spSelectExistingRequestDataOT", conn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    ...
                    SqlParameter timePay = new SqlParameter();
                    ...
                    Comments.SqlDbType = System.Data.SqlDbType.VarChar;
                    ...
                    timePay.SqlDbType = System.Data.SqlDbType.VarChar;
                    ...
                    Comments.Direction = System.Data.ParameterDirection.Output;
                    ...
                    timePay.Direction = System.Data.ParameterDirection.Output;
                    ...
                    string commentOut = Comments.Value.ToString();
                    ...
                    string timePayOut = timePay.Value.ToString();
                    ...
                    rblTimePay.SelectedValue = timePayOut;
        ...
        protected void CardEditable(object sender, EventArgs e)
        {
            ...
            tbEventNumber.ReadOnly = false;
            tbILHoliday.ReadOnly = false;
            ddlOTCode.Enabled = true;
            tbCaseNumber.ReadOnly = false;
            tbComments.ReadOnly = true;
            rblTimePay.Enabled = true;
        }
        ...
        protected void btnSaveClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("spInsertRequestOT", conn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.Add("@UserStar", SqlDbType.VarChar).Value = tbUserStar.Text;
                    ...
                    cmd.Parameters.Add("@EventNumber", SqlDbType.VarChar).Value = tbEventNumber.Text;
                    cmd.Parameters.Add("@ILHoliday", SqlDbType.VarChar).Value = tbILHoliday.Text;
                    cmd.Parameters.Add("@OTCode", SqlDbType.Int).Value = ddlOTCode.SelectedValue;
        ...
        protected void btnSubmitClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (SqlConnection conn = new SqlConnection(connstring))
                {
                    try
                    {
                        SqlCommand cmd = new SqlCommand("spUpdateRequestOT", conn);
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        protected void btnWithdrawClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spUpdateRequestStatusOT";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
        ...
        protected void btnApproveClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spUpdateRequestApproveOT";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
                    ...
                    cmd.Parameters.Add("@ApprovedRank", SqlDbType.VarChar).Value = tbApprovedRank.Text;
                    cmd.Parameters.Add("@ApprovedStar", SqlDbType.Int).Value = tbApprovedStar.Text;
                    cmd.Parameters.Add("@ApprovedDate", SqlDbType.VarChar).Value = tbApprovedDate.Text;
        ...
        protected void btnReturnClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spReturnRequestOT";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
