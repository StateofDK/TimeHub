<%@ Page Title="" Language="C#" MasterPageFile="~/TimeHub.Master" AutoEventWireup="true" CodeBehind="TrainingRequestTest.aspx.cs" Inherits="TimeHub2.TrainingRequestTest" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="page-title">
        <div class="title_left">
            <h3>Training Compensation Request</h3>
        </div>
    </div>
    <div class="row">
                ...
                <div class="x_content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 form-group form-horizontal">
                            <label>Request</label>
                            <p>
                                <asp:RadioButtonList runat="server" ID="rblCompType" RepeatLayout="flow" RepeatDirection="Horizontal" CssClass="btn-group" data-toggle="buttons">
                                    <asp:ListItem class="btn btn-default">Pay</asp:ListItem>
                                    <asp:ListItem class="btn btn-default">Time</asp:ListItem>
                                </asp:RadioButtonList>
                            </p>
                        </div>
                    </div>
        ...
        <div class="col-md-3 col-xs-12" style="height:100%;">
            <div class="x_panel">
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label>Training Code No.</label>
                            <asp:DropDownList runat="server" ID="ddlOvertimeCode" class="form-control"></asp:DropDownList>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
        ...
        <div class="col-md-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content">
                    <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                            <label>Trainee Name</small></label>
                            <input type="text" placeholder=".col-md-3" class="form-control">
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                            <label>Training Hours Certified By</label>
                            <input type="text" placeholder=".col-md-3" class="form-control">
                        </div>
                    </div>
                </div>
