<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserHomeOld.aspx.cs" Inherits="TimeHub2.WebForm7" %>
    ...
    <form id="userHome" runat="server">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div hidden="false">
                    <Label runat="server" ID="lblUserLoggedIn"></Label>
                </div>
            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <div class="col-sm-3 col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li><a href="SupervisorHome.aspx">Supervisor Home</a></li>
