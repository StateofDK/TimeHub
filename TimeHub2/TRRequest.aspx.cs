...
namespace TimeHub2
{
    public partial class TRRequest1 : System.Web.UI.Page
    {
        ...
        protected void ConfigurePageExisting(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                ...
                try
                {
                    SqlCommand cmd = new SqlCommand("spSelectExistingRequestDataTR", conn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    ...
                    SqlParameter ilHoliday = new SqlParameter();
                    SqlParameter otCode = new SqlParameter();
                    ...
                    ilHoliday.ParameterName = "@ILHoliday";
                    otCode.ParameterName = "@OTCode";
                    ...
                    ilHoliday.SqlDbType = System.Data.SqlDbType.VarChar;
                    otCode.SqlDbType = System.Data.SqlDbType.Int;
                    ...
                    ilHoliday.Direction = System.Data.ParameterDirection.Output;
                    otCode.Direction = System.Data.ParameterDirection.Output;
                    ...
                    cmd.Parameters.Add(ilHoliday);
                    cmd.Parameters.Add(otCode);
                    ...
                    string ilHolidayOut = ilHoliday.Value.ToString();
                    string otCodeOut = otCode.Value.ToString();
                    ...
                    tbILHoliday.Text = ilHolidayOut;
                    ddlOTCode.SelectedValue = otCodeOut;
        ...
        protected void btnSaveClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    SqlCommand cmd = new SqlCommand("spInsertRequestTR", conn);
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    ...
                    cmd.Parameters.Add("@CreateDate", SqlDbType.Date).Value = DateTime.Now.ToString();
        ...
        protected void btnSubmitClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                using (SqlConnection conn = new SqlConnection(connstring))
                {
                    try
                    {
                        SqlCommand cmd = new SqlCommand("spUpdateRequestTR", conn);
                        cmd.CommandType = System.Data.CommandType.StoredProcedure;
        ...
        protected void btnWithdrawClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spUpdateRequestStatusTR";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
        ...
        protected void btnApproveClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spUpdateRequestApproveTR";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
        ...
        protected void btnReturnClick(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(connstring))
            {
                try
                {
                    ...
                    cmd.CommandText = "spReturnRequestTR";
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Connection = conn;
