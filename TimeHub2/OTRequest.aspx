...
<head>
    ...
    <meta charset="utf-8">
    <title>Court Compensation Request</title>
    <meta name="generator" content="Bootply" />
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
    <link href="content/bootstrap.min.css" rel="stylesheet">
    <link href="stylesheets/OTRequest.css" rel="stylesheet" />
    <!--[if lt IE 9]>
                    ...
                    <div class="card">
                        <div class="box">
                            ...
                            <div class="line">
                                <div class="in-line-block">
                                    ...
                                    <asp:DropDownList runat="server" CssClass="textbox" ID="ddlAssignment" Enabled="false">
                        ...
                        <div class="box">
                            ...
                            <div class="line">
                                ...
                                <asp:DropDownList runat="server" CssClass="textbox" ID="ddlShift">
                                    <asp:ListItem Value='NULL' Text='Select' />
                            ...
                            <div class="line">
                                ...
                                <asp:TextBox runat="server" CssClass="textbox" ID="tbBeginningTime" type="TimeOfDay" AllowNegatives="false"></asp:TextBox>
                            </div>
                            <div class="line">
                                <label for="tbEndingTime">ending time</label>
                                <asp:TextBox runat="server" CssClass="textbox" ID="tbEndingTime" type="TimeOfDay" format="hh:nn" AllowNegatives="false"></asp:TextBox>
                            </div>
                            <div class="bottom-line">
                                <label for="tbTotalTime">total time worked</label>
                                <asp:TextBox runat="server" CssClass="textbox" ID="tbTotalTime" type="number" ReadOnly="true" AllowNegatives="false"></asp:TextBox>
                            </div>
                        </div>
                        <div class="box">
                            <div class="box-left">
